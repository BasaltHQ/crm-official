...
export const SeedTeamCard = () => {
    ...
    return (
        <div
            onClick={handleSeed}
            className={cn(
                "group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-4 md:p-6 hover:bg-white/10 transition-all duration-300 backdrop-blur-md shadow-lg hover:shadow-xl hover:scale-[1.02] text-left w-full h-full cursor-pointer"
            )}
        >
            ...
            <div className="relative z-10 flex flex-col items-center justify-center space-y-2 text-center h-full">
                <div className={`p-3 rounded-full bg-gradient-to-br from-amber-500/20 to-orange-500/20 border border-white/10 shadow-lg group-hover:scale-110 transition-transform duration-300 text-amber-400 ring-1 ring-white/20 group-hover:ring-white/40`}>
